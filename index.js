...
$(document).ready(function() {
  ...
  $('.product-box-layout4').click(function() {
    ...
    else if ($(this)[0].className.search('biryani productClicked') > -1) {
      $('#biryani').show().siblings('div').hide();

      $('html, body').animate({
        scrollTop: $('#biryani').offset().top
      }, 800, function() {});
...
function openWhatsapp() {
  ...
  window.open("https://wa.me/918520997742?text=" + wTxtEncoded);
}
